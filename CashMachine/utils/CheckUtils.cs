...
/// <summary>  
/// 该命名包含的类方法有：MD5校验、LRC异或值、CRC32校验值
/// </summary>  
namespace CheckUtils
{
    ...
    /// <summary>  
    /// 循环冗余检验：CRC-32-IEEE 802.3查表法 包含3个多态函数
    /// </summary>  
    public class CRC32
    {
        /// <summary>  
        /// 计算给定长度数据的32位CRC,无参数的  
        /// </summary>  
        ...
        /// <summary>
        /// 计算给定长度数据的32位CRC,有参 返回int类型结果
        /// 参数说明 data：要计算CRC的字节数组，length：从data的第0位开始起的长度
        /// </summary>  
        public static uint GetCRC32(byte[] data, int length)
        {
            uint crcValue = 0xFFFFFFFF;
            if (data != null)
            {
        ...
        /// <summary>
        /// 计算给定长度数据的32位CRC,有参 返回int类型结果
        /// 参数说明 offset:偏移量， data：要计算CRC的字节数组，length：从data的第offset位开始起的长度
        /// </summary>  
