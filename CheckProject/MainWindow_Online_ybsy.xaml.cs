...
{
    /// <summary>
    /// MainWindow_Online_ybsy.xaml 的交互逻辑 院办事员
    /// </summary>
    public partial class MainWindow_Online_ybsy : Window
    {
        /////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// 公共变量
        ...
        /// 构造函数
        /// </summary>
        public MainWindow_Online_ybsy(string userId, string userName)
        {
            //移交单位时将这些注释解封
            ////获取当前时间
            //long nowTime = (DateTime.Now.ToLocalTime().ToUniversalTime().Ticks - new DateTime(1970, 1, 1).Ticks) / 10000000;//2017-07-29 09:10:42.729 to 1454954944
